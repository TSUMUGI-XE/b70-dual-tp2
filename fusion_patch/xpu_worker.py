...
class XPUWorker(Worker):
    ...
    def init_device(self):
        ...
        # [B70 TP=2 fusion] This very all_reduce (an xpu-tensor collective on the world
        # group) is what triggers the oneCCL OFI/ATL handshake HANG on B70+xe same-RC.
        # When VLLM_XPU_HOSTSTAGED_TP=1 we deliberately bypass xccl (world group is gloo),
        # so skip the oneCCL warm-up and sanity-check the gloo path on a CPU tensor instead.
        import os as _os
